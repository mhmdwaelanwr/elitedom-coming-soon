...
(() => {
  const COPY = {
    ...
    ar: {
      ...
      incoming:'الإشارة وصلت', whatA:'إيه اللي', whatB:'جاي؟', glimpse:'هنوريك لمحة بس. كفاية تعرف إن في حاجة تستاهل إنك تستناها… والباقي يوم الإطلاق.',
      ...
      card2Title:'دوّر أقل. اختار أسرع.', card2Text:'بحث أسرع، مقارنة أوضح، وتجربة معمولة للي فعلًا بيدوّر على هاردوير كويس.',
